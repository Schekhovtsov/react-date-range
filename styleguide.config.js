...
module.exports = {
  ...
  title: 'react-date-range-headless',
  showSidebar: false,
  template: {
    head: {
      links: [
  ...
  getComponentPathLine(componentPath) {
    ...
    return `import { ${name} } from 'react-date-range-headless';`;
  },
  ...
  moduleAliases: {
    'react-date-range-headless/dist': path.resolve(__dirname, moduleSource),
    'react-date-range-headless': path.resolve(__dirname, moduleSource),
  },
  webpackConfig: {
    module: {
      rules: [
